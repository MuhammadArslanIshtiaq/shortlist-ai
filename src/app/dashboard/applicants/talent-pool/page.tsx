      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Filter Talent Pool</h3>
            <button
              onClick={onClose}
      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Talent Pool Candidate Details</h2>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="p-6">
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full flex items-center justify-center text-white font-semibold text-lg">
              ...
              <div className="flex items-center space-x-3">
                {applicant.matchingScore && (
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full flex items-center justify-center text-white text-lg font-semibold">
                      {applicant.matchingScore}
                    </div>
            ...
            <div className="bg-white rounded-lg p-6 mb-6 border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                {applicant.analysis?.summary || 
                  (applicant.matchingScore ? 
                    `This candidate has a ${applicant.matchingScore}% match score for the position. They have been added to the talent pool for future opportunities.` : 
                    'This candidate has been added to the talent pool for future opportunities.'
                  )
                }
              </p>
            </div>
                ...
                <ul className="space-y-2">
                  {applicant.analysis?.strengths && applicant.analysis.strengths.length > 0 ? (
                    ...
                    <>
                      ...
                      <li className="text-gray-700 flex items-start">
                        <span className="text-green-500 mr-2 mt-1">•</span>
                        Promising candidate for future roles
                      </li>
                    </>
                  )}
                </ul>
...
export default function TalentPool() {
  ...
  useEffect(() => {
    ...
    if (applicantId && talentPoolApplicants.length > 0) {
      const applicant = talentPoolApplicants.find(a => a.applicantId === applicantId);
      if (applicant) {
  ...
  }, [searchParams, talentPoolApplicants]);

  // Additional effect to handle applicantId when applicants data loads after the page
  useEffect(() => {
    const applicantId = searchParams.get('applicantId');
    if (applicantId && talentPoolApplicants.length > 0 && !selectedApplicant) {
      const applicant = talentPoolApplicants.find(a => a.applicantId === applicantId);
      if (applicant) {
        setSelectedApplicant(applicant);
        // Remove the query parameter from the URL
  ...
  }, [talentPoolApplicants, searchParams, selectedApplicant]);
    ...
    return (
      <div className="p-6 bg-gray-50 min-h-full flex items-center justify-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-gray-600">Loading talent pool applicants...</span>
        </div>
      </div>
    );
  }
                    ...
                    <tr key={applicant.applicantId} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          ...
                          <span className="font-medium text-gray-900">{applicant.firstName} {applicant.lastName}</span>
                        </div>
                      </td>
